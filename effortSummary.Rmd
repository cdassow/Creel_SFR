...
> **How much less creel data could be collected, on an individual survey basis while still maintaining the stratified random sampling design, and still produce effort estimates that are NOT significantly different from exploitation rates obtained using the current creel survey design?**
...
ggplot(bpval.comp.y)+theme_classic()+
  ...
  coord_cartesian(ylim=c(0,1))
```
```{r yearGRmetric, fig.cap="Gelman-Rubin diagnostic results for the year-by-year model fitting. All years with  available data  (more than one non-zero exploitation rate) had models successfully converge with a Gelman-Rubin score below the 1.1 threshold required for convergence (red horizonal line)."}
# model convergence
...
set.seed(10)
for(i in 1:nrow(pars.a)){
  tempdat=rlnorm(n=length(ttrExp$total.eff[ttrExp$treat=="actual"]),
                 meanlog = pars.a[i,1],
                 sdlog = pars.a[i,2])
  pval.actual$alpha[i]=pars.a[i,1]
  pval.actual$beta[i]=pars.a[i,2]
  ...
  ct=chisq.test(tempdat, p=ttrExp$total.eff[ttrExp$treat=="actual"], rescale.p = T)
  pval.actual$x2[i]=ct$p.value
  f.test=var.test(log(tempdat),log(ttrExp$total.eff[ttrExp$treat=="actual"]))
...
actual.cv=sd(log(ttrExp$total.eff[ttrExp$treat=="actual"]))/mean(log(ttrExp$total.eff[ttrExp$treat=="actual"]))
actual.sd=sd(log(ttrExp$total.eff[ttrExp$treat=="actual"]))
actual.med=median(log(ttrExp$total.eff[ttrExp$treat=="actual"]))
actual.kurt=kurtosis(log(ttrExp$total.eff[ttrExp$treat=="actual"]))
actual.x2=chisq.test(ttrExp$total.eff[ttrExp$treat=="actual"],p=ttrExp$total.eff[ttrExp$treat=="actual"],rescale.p = T)
actual.f=var.test(log(ttrExp$total.eff[ttrExp$treat=="actual"]),log(ttrExp$total.eff[ttrExp$treat=="actual"]))
...
set.seed(10)
for(i in 1:nrow(pars.nw)){
  tempdat=rlnorm(n=length(ttrExp$total.eff[ttrExp$treat=="noWinter"]),
                 meanlog = pars.nw[i,1],
                 sdlog = pars.nw[i,2])
  pval.noWinter$alpha[i]=pars.nw[i,1]
  pval.noWinter$beta[i]=pars.nw[i,2]
  ...
  ct=chisq.test(tempdat, p=ttrExp$total.eff[ttrExp$treat=="noWinter"], rescale.p = T)
  pval.noWinter$x2[i]=ct$p.value
  f.test=var.test(log(tempdat),log(ttrExp$total.eff[ttrExp$treat=="noWinter"]))
...
noWinter.cv=sd(log(ttrExp$total.eff[ttrExp$treat=="noWinter"]))/mean(log(ttrExp$total.eff[ttrExp$treat=="noWinter"]))
noWinter.sd=sd(log(ttrExp$total.eff[ttrExp$treat=="noWinter"]))
noWinter.med=median(log(ttrExp$total.eff[ttrExp$treat=="noWinter"]))
noWinter.kurt=kurtosis(log(ttrExp$total.eff[ttrExp$treat=="noWinter"]))
noWinter.x2=chisq.test(ttrExp$total.eff[ttrExp$treat=="noWinter"],p=ttrExp$total.eff[ttrExp$treat=="noWinter"],rescale.p = T)
noWinter.f=var.test(log(ttrExp$total.eff[ttrExp$treat=="noWinter"]),log(ttrExp$total.eff[ttrExp$treat=="noWinter"]))
...
set.seed(10)
for(i in 1:nrow(pars.ma)){
  tempdat=rlnorm(n=length(ttrExp$total.eff[ttrExp$treat=="mayAug"]),
                 meanlog = pars.ma[i,1],
                 sdlog = pars.ma[i,2])
  pval.mayAug$alpha[i]=pars.ma[i,1]
  pval.mayAug$beta[i]=pars.ma[i,2]
  ...
  ct=chisq.test(tempdat, p=ttrExp$total.eff[ttrExp$treat=="mayAug"], rescale.p = T)
  pval.mayAug$x2[i]=ct$p.value
  f.test=var.test(log(tempdat),log(ttrExp$total.eff[ttrExp$treat=="mayAug"]))
...
mayAug.cv=sd(log(ttrExp$total.eff[ttrExp$treat=="mayAug"]))/mean(log(ttrExp$total.eff[ttrExp$treat=="mayAug"]))
mayAug.sd=sd(log(ttrExp$total.eff[ttrExp$treat=="mayAug"]))
mayAug.med=median(log(ttrExp$total.eff[ttrExp$treat=="mayAug"]))
mayAug.kurt=kurtosis(log(ttrExp$total.eff[ttrExp$treat=="mayAug"]))
mayAug.x2=chisq.test(ttrExp$total.eff[ttrExp$treat=="mayAug"],p=ttrExp$total.eff[ttrExp$treat=="mayAug"],rescale.p = T)
mayAug.f=var.test(log(ttrExp$total.eff[ttrExp$treat=="mayAug"]),log(ttrExp$total.eff[ttrExp$treat=="mayAug"]))
...
set.seed(10)
for(i in 1:nrow(pars.wd25)){
  tempdat=rlnorm(n=length(ttrExp$total.eff[ttrExp$treat=="wd25"]),
                 meanlog = pars.wd25[i,1],
                 sdlog = pars.wd25[i,2])
  pval.wd25$alpha[i]=pars.wd25[i,1]
  pval.wd25$beta[i]=pars.wd25[i,2]
  ...
  ct=chisq.test(tempdat, p=ttrExp$total.eff[ttrExp$treat=="wd25"], rescale.p = T)
  pval.wd25$x2[i]=ct$p.value
  f.test=var.test(log(tempdat),log(ttrExp$total.eff[ttrExp$treat=="wd25"]))
...
wd25.cv=sd(log(ttrExp$total.eff[ttrExp$treat=="wd25"]))/mean(log(ttrExp$total.eff[ttrExp$treat=="wd25"]))
wd25.sd=sd(log(ttrExp$total.eff[ttrExp$treat=="wd25"]))
wd25.med=median(log(ttrExp$total.eff[ttrExp$treat=="wd25"]))
wd25.kurt=kurtosis(log(ttrExp$total.eff[ttrExp$treat=="wd25"]))
wd25.x2=chisq.test(ttrExp$total.eff[ttrExp$treat=="wd25"],p=ttrExp$total.eff[ttrExp$treat=="wd25"],rescale.p = T)
wd25.f=var.test(log(ttrExp$total.eff[ttrExp$treat=="wd25"]),log(ttrExp$total.eff[ttrExp$treat=="wd25"]))
...
set.seed(10)
for(i in 1:nrow(pars.wd50)){
  tempdat=rlnorm(n=length(ttrExp$total.eff[ttrExp$treat=="wd50"]),
                 meanlog = pars.wd50[i,1],
                 sdlog = pars.wd50[i,2])
  pval.wd50$alpha[i]=pars.wd50[i,1]
  pval.wd50$beta[i]=pars.wd50[i,2]
  ...
  ct=chisq.test(tempdat, p=ttrExp$total.eff[ttrExp$treat=="wd50"], rescale.p = T)
  pval.wd50$x2[i]=ct$p.value
  f.test=var.test(log(tempdat),log(ttrExp$total.eff[ttrExp$treat=="wd50"]))
...
wd50.cv=sd(log(ttrExp$total.eff[ttrExp$treat=="wd50"]))/mean(log(ttrExp$total.eff[ttrExp$treat=="wd50"]))
wd50.sd=sd(log(ttrExp$total.eff[ttrExp$treat=="wd50"]))
wd50.med=median(log(ttrExp$total.eff[ttrExp$treat=="wd50"]))
wd50.kurt=kurtosis(log(ttrExp$total.eff[ttrExp$treat=="wd50"]))
wd50.x2=chisq.test(ttrExp$total.eff[ttrExp$treat=="wd50"],p=ttrExp$total.eff[ttrExp$treat=="wd50"],rescale.p = T)
wd50.f=var.test(log(ttrExp$total.eff[ttrExp$treat=="wd50"]),log(ttrExp$total.eff[ttrExp$treat=="wd50"]))
...
set.seed(10)
for(i in 1:nrow(pars.we50)){
  tempdat=rlnorm(n=length(ttrExp$total.eff[ttrExp$treat=="we50"]),
                 meanlog = pars.we50[i,1],
                 sdlog = pars.we50[i,2])
  pval.we50$alpha[i]=pars.we50[i,1]
  pval.we50$beta[i]=pars.we50[i,2]
  ...
  ct=chisq.test(tempdat, p=ttrExp$total.eff[ttrExp$treat=="we50"], rescale.p = T)
  pval.we50$x2[i]=ct$p.value
  f.test=var.test(log(tempdat),log(ttrExp$total.eff[ttrExp$treat=="we50"]))
...
we50.cv=sd(log(ttrExp$total.eff[ttrExp$treat=="we50"]))/mean(log(ttrExp$total.eff[ttrExp$treat=="we50"]))
we50.sd=sd(log(ttrExp$total.eff[ttrExp$treat=="we50"]))
we50.med=median(log(ttrExp$total.eff[ttrExp$treat=="we50"]))
we50.kurt=kurtosis(log(ttrExp$total.eff[ttrExp$treat=="we50"]))
we50.x2=chisq.test(ttrExp$total.eff[ttrExp$treat=="we50"],p=ttrExp$total.eff[ttrExp$treat=="we50"],rescale.p = T)
we50.f=var.test(log(ttrExp$total.eff[ttrExp$treat=="we50"]),log(ttrExp$total.eff[ttrExp$treat=="we50"]))
