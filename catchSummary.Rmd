...
#saveRDS(yearLoopOutput, file = "yearLoopOutput_walleyecatch_8.19.25.RData")
...
yearLoopOutput=readRDS("yearLoopOutput_walleyecatch_8.19.25.RData")
...
we50.p.gamma=ggplot(we50Comp.gamma)+theme_classic()+
  geom_density(aes(x=catch.acre,fill=treat),alpha=0.2)+coord_cartesian(xlim = c(0,250))+
  scale_fill_viridis_d()+labs(x="Annual Catch per Acre", y="Density", title = "50% of Weekend \nCreel Visits/Month \nRemoved", fill=element_blank())
