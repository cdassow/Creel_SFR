...
harvestEstimates=charv%>%
  ...
  mutate(harvAcre=spp.harvest/(lake.area/2.47))
...
set.seed(3)
aComp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="actual"],rlnorm(n=length(modDat$total.harv[modDat$treat=="actual"]),
...
set.seed(3)
nwComp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="noWinter"],rlnorm(n=length(modDat$total.harv[modDat$treat=="noWinter"]),
...
set.seed(3)
maComp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="mayAug"],rlnorm(n=length(modDat$total.harv[modDat$treat=="mayAug"]),
...
set.seed(3)
wd25Comp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="wd25"],rlnorm(n=length(modDat$total.harv[modDat$treat=="wd25"]),
...
set.seed(3)
wd50Comp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="wd50"],rlnorm(n=length(modDat$total.harv[modDat$treat=="wd50"]),
...
set.seed(3)
we50Comp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="we50"],rlnorm(n=length(modDat$total.harv[modDat$treat=="we50"]),
...
a.p=ggplot(aComp)+theme_classic()+
  geom_density(aes(x=log(harv.hectare),fill=treat),alpha=0.2)+
...
nwComp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="actual"],rlnorm(n=length(modDat$total.harv[modDat$treat=="actual"]),
                                                                       meanlog = median(pars.nw[,1]),
                                                                       sdlog = median(pars.nw[,2]))),
                  treat=c(rep("actual",length(modDat$total.harv[modDat$treat=="actual"])),rep("model",length(modDat$total.harv[modDat$treat=="actual"]))))

maComp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="actual"],rlnorm(n=length(modDat$total.harv[modDat$treat=="actual"]),
                                                                     meanlog = median(pars.ma[,1]),
                                                                     sdlog = median(pars.ma[,2]))),
                  treat=c(rep("actual",length(modDat$total.harv[modDat$treat=="actual"])),rep("model",length(modDat$total.harv[modDat$treat=="actual"]))))

wd25Comp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="actual"],rlnorm(n=length(modDat$total.harv[modDat$treat=="actual"]),
                                                                     meanlog = median(pars.wd25[,1]),
                                                                     sdlog = median(pars.wd25[,2]))),
                    treat=c(rep("actual",length(modDat$total.harv[modDat$treat=="actual"])),rep("model",length(modDat$total.harv[modDat$treat=="actual"]))))

wd50Comp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="actual"],rlnorm(n=length(modDat$total.harv[modDat$treat=="actual"]),
                                                                     meanlog = median(pars.wd50[,1]),
                                                                     sdlog = median(pars.wd50[,2]))),
                    treat=c(rep("actual",length(modDat$total.harv[modDat$treat=="actual"])),rep("model",length(modDat$total.harv[modDat$treat=="actual"]))))

we50Comp=data.frame(harv.hectare=c(modDat$total.harv[modDat$treat=="actual"],rlnorm(n=length(modDat$total.harv[modDat$treat=="actual"]),
                                                                     meanlog = median(pars.we50[,1]),
                                                                     sdlog = median(pars.we50[,2]))),
                    treat=c(rep("actual",length(modDat$total.harv[modDat$treat=="actual"])),rep("model",length(modDat$total.harv[modDat$treat=="actual"]))))
...
a.p=ggplot(aComp)+theme_classic()+
  geom_density(aes(x=log(harv.hectare),fill=treat),alpha=0.2)+
  scale_fill_viridis_d()+labs(x="Log(Annual Harvest per Hectare)", y="Density", title = "Actual", fill=element_blank())
nw.p=ggplot(nwComp)+theme_classic()+
  geom_density(aes(x=log(harv.hectare),fill=treat),alpha=0.2)+
  scale_fill_viridis_d()+labs(x="Log(Annual Harvest per Hectare)", y="Density", title = "No Winter Data \n(April - October)", fill=element_blank())
ma.p=ggplot(maComp)+theme_classic()+
  geom_density(aes(x=log(harv.hectare),fill=treat),alpha=0.2)+
  scale_fill_viridis_d()+labs(x="Log(Annual Harvest per Hectare)", y="Density", title = "May - August \nData Only", fill=element_blank())
wd25.p=ggplot(wd25Comp)+theme_classic()+
  geom_density(aes(x=log(harv.hectare),fill=treat),alpha=0.2)+
  scale_fill_viridis_d()+labs(x="Log(Annual Harvest per Hectare)", y="Density", title = "25% of Weekday \nCreel Visits/Month \nRemoved", fill=element_blank())
wd50.p=ggplot(wd25Comp)+theme_classic()+
  geom_density(aes(x=log(harv.hectare),fill=treat),alpha=0.2)+
  scale_fill_viridis_d()+labs(x="Log(Annual Harvest per Hectare)", y="Density", title = "50% of Weekday \nCreel Visits/Month \nRemoved", fill=element_blank())
we50.p=ggplot(we50Comp)+theme_classic()+
  geom_density(aes(x=log(harv.hectare),fill=treat),alpha=0.2)+
  scale_fill_viridis_d()+labs(x="Log(Annual Harvest per Hectare)", y="Density", title = "50% of Weekdend \nCreel Visits/Month \nRemoved", fill=element_blank())
...
kable(exceedSummary,
      ...
      caption = "Counts of the number of times the annual harvest per acre estimate for the reduced data scenario differs from the actual annual harvest per hectare estimate for that treatment by more than 1 standard deviation. NAs ocurred where there was no variance in the harvest estimate and thus no standard deviation could be calculated for the actual data.")
...
#saveRDS(yearLoopOutput, file = "yearLoopOutput_harvest_9.23.25.RData")
...
yearLoopOutput=readRDS("yearLoopOutput_harvest_9.23.25.RData")
...
```{r year-loop-model-fit, fig.cap="Comparison of standard deviation for bayesian p-values comparing the actual data to the simulated data for the creel year and data reduction scenario."}
...
```{r yearLoopComparisonToActual, fig.cap="Comparison of the standard deviation for bayesian p-values comparing the simulated data from each creel year and data reduction scenario to the actual data for that same creel year."}
...
set.seed(10)
aComp.lnorm=data.frame(harv.hectare=c(ttrExp$total.harv[ttrExp$treat=="actual"],rlnorm(n=length(ttrExp$total.harv[ttrExp$treat=="actual"]),
...
aComp.gamma=data.frame(harv.hectare=c(ttrExp$total.harv[ttrExp$treat=="actual"],rgamma(n=length(ttrExp$total.harv[ttrExp$treat=="actual"]),
                                                                    shape = median(pars.a.gamma[,1]),
                                                                    rate = median(pars.a.gamma[,2]))),
                  treat=c(rep("observed",length(ttrExp$total.harv[ttrExp$treat=="actual"])),rep("pred",length(ttrExp$total.harv[ttrExp$treat=="actual"]))))

ln=ggplot(aComp.lnorm)+theme_classic()+
  geom_density(aes(x=harv.hectare, fill=treat),alpha=0.3)+
...
aComp.gamma=data.frame(harv.hectare=c(ttrExp$total.harv[ttrExp$treat=="actual"],rgamma(n=length(ttrExp$total.harv[ttrExp$treat=="actual"]),
                                                                    ...
                                                                    rate = median(pars.a.gamma[,2]))),
                  treat=c(rep("observed",length(ttrExp$total.harv[ttrExp$treat=="actual"])),rep("pred",length(ttrExp$total.harv[ttrExp$treat=="actual"]))))
nwComp.gamma=data.frame(harv.hectare=c(ttrExp$total.harv[ttrExp$treat=="noWinter"],rgamma(n=length(ttrExp$total.harv[ttrExp$treat=="noWinter"]),
...
maComp.gamma=data.frame(harv.hectare=c(ttrExp$total.harv[ttrExp$treat=="mayAug"],rgamma(n=length(ttrExp$total.harv[ttrExp$treat=="mayAug"]),
...
wd25Comp.gamma=data.frame(harv.hectare=c(ttrExp$total.harv[ttrExp$treat=="wd25"],rgamma(n=length(ttrExp$total.harv[ttrExp$treat=="wd25"]),
...
gelmanDiagnostics(harv.actual.gamma) # converged
gelmanDiagnostics(harv.nw.gamma) # converged
gelmanDiagnostics(harv.ma.gamma) # not converged
gelmanDiagnostics(harv.25wd.gamma) # converged
gelmanDiagnostics(harv.50wd.gamma) # converged
gelmanDiagnostics(harv.50we.gamma) # converged
